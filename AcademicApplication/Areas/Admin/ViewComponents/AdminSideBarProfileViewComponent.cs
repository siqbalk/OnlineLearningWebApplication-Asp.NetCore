...
{
    public class AdminSideBarProfileViewComponent:ViewComponent
    {
        private UserManager<AppUser> _userManager;
        private RoleManager<AppRole> _roleManager;

        public AdminSideBarProfileViewComponent(UserManager<AppUser> userManager,RoleManager<AppRole> roleManager)
        {
