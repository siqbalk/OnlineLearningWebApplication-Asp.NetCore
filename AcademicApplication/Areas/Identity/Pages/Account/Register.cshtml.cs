...
namespace AcademicApplication.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //Calling OnPostSendVerificationEmailAsync to verify email....
                    await OnPostSendVerificationEmailAsync(user);
        ...
        //Verify Email......
        public async Task<IActionResult> OnPostSendVerificationEmailAsync(AppUser user)
        {
            if (!ModelState.IsValid)
            {
                return Page();
